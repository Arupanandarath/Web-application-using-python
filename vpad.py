...
main_application.title('vpad_text_editor')
...
def change_font(event=None): ## or you can use main_application  at the place of event=None
    global current_font_family
    current_font_family = font_family.get()
    text_editor.configure(font=(current_font_family, current_font_size))

def change_fontsize(event=None):     ## or you can use main_application  at the place of event=None
...
edit.add_command(label='Clear All', image=clear_all_icon, compound=tk.LEFT, accelerator='Ctrl+Alt+x', command=lambda:text_editor.delet(1.0, tk.END))
...
count = 0
for i in color_dict:
    color_theme.add_radiobutton(label=i, image=color_icon[count],variable=theme_choise, compound=tk.LEFT, command=change_theme)
    count += 1
